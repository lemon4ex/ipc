...
/*!
 * @typedef xpc_lite_type_t
 * A type that describes XPC object types.
 */
typedef const struct _xpc_lite_type_s * xpc_lite_type_t;
#ifndef __XPC_BUILDING_XPC__
#define XPC_TYPE(type) const struct _xpc_lite_type_s type
#endif // __XPC_BUILDING_XPC__

/*!
 * @typedef xpc_lite_object_t
 ...
 * caller's responsibility to call xpc_lite_release() on them when they are no longer
 * needed.
 */
...
// */
//OS_OBJECT_DECL(xpc_lite_object);
//#ifndef __XPC_PROJECT_BUILD__
//#define XPC_DECL(name) typedef xpc_lite_object_t name##_t
//#endif // __XPC_PROJECT_BUILD__
//
//#define XPC_GLOBAL_OBJECT(object) ((OS_OBJECT_BRIDGE xpc_lite_object_t)&(object))
//#define XPC_RETURNS_RETAINED OS_OBJECT_RETURNS_RETAINED
//XPC_INLINE XPC_NONNULL_ALL
//void
//_xpc_lite_object_validate(xpc_lite_object_t object) {
//	void *isa = *(void * volatile *)(OS_OBJECT_BRIDGE void *)object;
//	(void)isa;
//}
//#else // OS_OBJECT_USE_OBJC
typedef void * xpc_lite_object_t;
 ...
 */
#if __BLOCKS__
typedef void (^xpc_lite_handler_t)(xpc_lite_object_t object);
#endif // __BLOCKS__ 
 ...
 */
#define XPC_TYPE_CONNECTION (&_xpc_lite_type_connection)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_connection);
XPC_DECL(xpc_lite_connection);

/*!
 * @typedef xpc_lite_connection_handler_t
 ...
 * See the documentation for {@link xpc_lite_connection_set_event_handler} for the
 * semantics associated with the received connection.
 */
typedef void (*xpc_lite_connection_handler_t)(xpc_lite_connection_t connection);
 ...
 * xpc_lite_connection_create_from_endpoint() to create as many distinct connections
 * as desired. 
 */
#define XPC_TYPE_ENDPOINT (&_xpc_lite_type_endpoint)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_endpoint);
XPC_DECL(xpc_lite_endpoint);
 ...
 * do not accept NULL.
 */
#define XPC_TYPE_NULL (&_xpc_lite_type_null)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_null);

/*!
 * @define XPC_TYPE_BOOL
 * A type representing a Boolean value.
 */
#define XPC_TYPE_BOOL (&_xpc_lite_type_bool)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_bool);
 ...
 */
#define XPC_BOOL_TRUE XPC_GLOBAL_OBJECT(_xpc_lite_bool_true)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
const struct _xpc_lite_bool_s _xpc_lite_bool_true;
 ...
 * object against this constant to determine its value.
 */
#define XPC_BOOL_FALSE XPC_GLOBAL_OBJECT(_xpc_lite_bool_false)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
const struct _xpc_lite_bool_s _xpc_lite_bool_false;

/*!
 * @define XPC_TYPE_INT64
 * A type representing a signed, 64-bit integer value.
 */
#define XPC_TYPE_INT64 (&_xpc_lite_type_int64)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_int64);

/*!
 * @define XPC_TYPE_UINT64
 * A type representing an unsigned, 64-bit integer value.
 */
#define XPC_TYPE_UINT64 (&_xpc_lite_type_uint64)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_uint64);

/*!
 * @define XPC_TYPE_DOUBLE
 * A type representing an IEEE-compliant, double-precision floating point value.
 */
#define XPC_TYPE_DOUBLE (&_xpc_lite_type_double)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_double);
 ...
 * or leap seconds.
 */
#define XPC_TYPE_DATE (&_xpc_lite_type_date)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_date);

/*!
 * @define XPC_TYPE_DATA
 * A type representing a an arbitrary buffer of bytes.
 */
#define XPC_TYPE_DATA (&_xpc_lite_type_data)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_data);

/*!
 * @define XPC_TYPE_STRING
 * A type representing a NUL-terminated C-string.
 */
#define XPC_TYPE_STRING (&_xpc_lite_type_string)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_string);

/*!
 * @define XPC_TYPE_UUID
 * A type representing a Universally Unique Identifier as defined by uuid(3). 
 */
#define XPC_TYPE_UUID (&_xpc_lite_type_uuid)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_uuid);

/*!
 * @define XPC_TYPE_FD
 * A type representing a POSIX file descriptor.
 */
#define XPC_TYPE_FD (&_xpc_lite_type_fd)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_fd);

/*!
 * @define XPC_TYPE_SHMEM
 * A type representing a region of shared memory.
 */
#define XPC_TYPE_SHMEM (&_xpc_lite_type_shmem)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_shmem);
 ...
 */
#define XPC_TYPE_ARRAY (&_xpc_lite_type_array)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_array);
 ...
 */
#define XPC_TYPE_DICTIONARY (&_xpc_lite_type_dictionary)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_dictionary);

/*!
 * @define XPC_TYPE_ERROR
 * A type representing an error object. Errors in XPC are dictionaries, but
 * xpc_lite_get_type() will return this type when given an error object. You
 ...
 */
#define XPC_TYPE_ERROR (&_xpc_lite_type_error)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_error);
 ...
 */
#define XPC_ERROR_KEY_DESCRIPTION _xpc_lite_error_key_description
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
const char *const _xpc_lite_error_key_description;
 ...
 */
#define XPC_EVENT_KEY_NAME _xpc_lite_event_key_name
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
const char *const _xpc_lite_event_key_name;
 ...
 *
 * @discussion
 * Calls to xpc_lite_retain() must be balanced with calls to xpc_lite_release()
 ...
 * it is the caller's responsibility to call xpc_lite_release() on those objects when
...
xpc_lite_type_t
xpc_lite_get_type(xpc_lite_object_t object);

/*!
 * @function xpc_lite_copy
 *
 * @abstract
 ...
 *
 * @discussion
 * When called on an array or dictionary, xpc_lite_copy() will perform a deep copy.
 *
...
xpc_lite_object_t
xpc_lite_copy(xpc_lite_object_t object);

/*!
 * @function xpc_lite_equal
 *
 * @abstract
 ...
 *
 * Two objects being equal implies that their hashes (as returned by xpc_lite_hash())
 * are also equal.
 */
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT XPC_NONNULL1 XPC_NONNULL2 XPC_WARN_RESULT
bool
xpc_lite_equal(xpc_lite_object_t object1, xpc_lite_object_t object2);

/*!
 * @function xpc_lite_hash
 *
 * @abstract
...
size_t
xpc_lite_hash(xpc_lite_object_t object);

/*!
 * @function xpc_lite_copy_description
 *
 * @abstract
...
char *
xpc_lite_copy_description(xpc_lite_object_t object);

#pragma mark XPC Object Types
#pragma mark Null
/*!
 * @function xpc_lite_null_create
 *
 * @abstract
...
/*!
 * @function xpc_lite_bool_get_value
 *
 * @abstract
...
/*!
 * @function xpc_lite_int64_create
 *
 * @abstract
...
/*!
 * @function xpc_lite_int64_get_value
 *
 * @abstract
...
/*!
 * @function xpc_lite_uint64_create
 *
 * @abstract
...
/*!
 * @function xpc_lite_uint64_get_value
 *
 * @abstract
...
#pragma mark Double
/*!
 * @function xpc_lite_double_create
 *
 * @abstract
...
/*!
 * @function xpc_lite_double_get_value
 *
 * @abstract
...
/*!
 * @function xpc_lite_date_create_from_current
 *
 * @abstract
...
/*!
 * @function xpc_lite_date_get_value
 *
 * @abstract
...
#if 0
/*!
 * @function xpc_lite_data_create_with_dispatch_data
 *
 * @abstract
...
/*!
 * @function xpc_lite_data_get_length
 *
 * @abstract
...
/*!
 * @function xpc_lite_data_get_bytes_ptr
 *
 * @abstract
...
/*!
 * @function xpc_lite_data_get_bytes
 *
 * @abstract
...
size_t
xpc_lite_data_get_bytes(xpc_lite_object_t xdata,
	void *buffer, size_t off, size_t length);

#pragma mark String
/*!
 * @function xpc_lite_string_create
 *
 * @abstract
...
/*!
 * @function xpc_lite_string_create_with_format
 *
 * @abstract
...
/*!
 * @function xpc_lite_string_create_with_format_and_arguments
 *
 * @abstract
 * Creates an XPC object representing a C-string that is generated from the
...
/*!
 * @function xpc_lite_string_get_length
 *
 * @abstract
...
/*!
 * @function xpc_lite_string_get_string_ptr
 *
 * @abstract
...
/*!
 * @function xpc_lite_uuid_get_bytes
 *
 * @abstract
 ...
 * number will not compare equally with xpc_lite_equal(). This is also true of a
 * file descriptor object created using xpc_lite_copy() and the original.
 *
...
XPC_EXPORT XPC_MALLOC XPC_RETURNS_RETAINED XPC_WARN_RESULT
xpc_lite_object_t
xpc_lite_fd_create(int fd);

/*!
 * @function xpc_lite_fd_dup
 *
 * @abstract
 ...
 * xpc_lite_fd_create(). If the descriptor could not be created or if the given
 * object was not an XPC file descriptor, -1 is returned.
 *
 * @discussion
 * Multiple invocations of xpc_lite_fd_dup() will not return the same file descriptor
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1
int
xpc_lite_fd_dup(xpc_lite_object_t xfd);

#pragma mark Shared Memory
/*!
 * @function xpc_lite_shmem_create
 *
 * @abstract
...
XPC_EXPORT XPC_MALLOC XPC_RETURNS_RETAINED XPC_WARN_RESULT XPC_NONNULL1
xpc_lite_object_t
xpc_lite_shmem_create(void *region, size_t length);

/*!
 * @function xpc_lite_shmem_map
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL_ALL
size_t
xpc_lite_shmem_map(xpc_lite_object_t xshmem, void **region);

#pragma mark Array
/*!
 * @typedef xpc_lite_array_applier_t
 ...
 */
#ifdef __BLOCKS__
typedef bool (^xpc_lite_array_applier_t)(size_t index, xpc_lite_object_t value);
#endif // __BLOCKS__ 

/*!
 * @function xpc_lite_array_create
 *
 * @abstract
...
XPC_EXPORT XPC_MALLOC XPC_RETURNS_RETAINED XPC_WARN_RESULT
xpc_lite_object_t
xpc_lite_array_create(const xpc_lite_object_t *objects, size_t count);

/*!
 * @function xpc_lite_array_set_value
 *
 * @abstract
...
void
xpc_lite_array_set_value(xpc_lite_object_t xarray, size_t index, xpc_lite_object_t value);

/*!
 * @function xpc_lite_array_append_value
 *
 * @abstract
...
void
xpc_lite_array_append_value(xpc_lite_object_t xarray, xpc_lite_object_t value);

/*!
 * @function xpc_lite_array_get_count
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1
size_t
xpc_lite_array_get_count(xpc_lite_object_t xarray);

/*!
 * @function xpc_lite_array_get_value
 *
 * @abstract
 ...
 * indexes as specified in xpc_lite_array_set_value().
 * 
 * @result
...
xpc_lite_object_t
xpc_lite_array_get_value(xpc_lite_object_t xarray, size_t index);

/*!
 * @function xpc_lite_array_apply
 *
 * @abstract
...
XPC_EXPORT XPC_NONNULL_ALL
bool
xpc_lite_array_apply(xpc_lite_object_t xarray, xpc_lite_array_applier_t applier);
#endif // __BLOCKS__ 
...
/*!
 * @function xpc_lite_array_set_bool
 *
 * @abstract
 ...
 * with {@link xpc_lite_array_get_value()}.
 */
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT XPC_NONNULL1
void
xpc_lite_array_set_bool(xpc_lite_object_t xarray, size_t index, bool value);

/*!
 * @function xpc_lite_array_set_int64
 *
 * @abstract
...
XPC_EXPORT XPC_NONNULL1
void
xpc_lite_array_set_int64(xpc_lite_object_t xarray, size_t index, int64_t value);

/*!
 * @function xpc_lite_array_set_uint64
 *
 * @abstract
...
XPC_EXPORT XPC_NONNULL1
void
xpc_lite_array_set_uint64(xpc_lite_object_t xarray, size_t index, uint64_t value);

/*!
 * @function xpc_lite_array_set_double
 *
 * @abstract
...
XPC_EXPORT XPC_NONNULL1
void
xpc_lite_array_set_double(xpc_lite_object_t xarray, size_t index, double value);

/*!
 * @function xpc_lite_array_set_date
 *
 * @abstract
 ...
 * inserted may be safely retrieved with {@link xpc_lite_array_get_value()}.
 */
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT XPC_NONNULL1
void
xpc_lite_array_set_date(xpc_lite_object_t xarray, size_t index, int64_t value);

/*!
 * @function xpc_lite_array_set_data
 *
 * @abstract
...
XPC_EXPORT XPC_NONNULL1 XPC_NONNULL3
void
xpc_lite_array_set_data(xpc_lite_object_t xarray, size_t index, const void *bytes,
	size_t length);

/*!
 * @function xpc_lite_array_set_string
 *
 * @abstract
...
XPC_EXPORT XPC_NONNULL1 XPC_NONNULL3
void
xpc_lite_array_set_string(xpc_lite_object_t xarray, size_t index, const char *string);

/*!
 * @function xpc_lite_array_set_uuid
 *
 * @abstract
...
XPC_EXPORT XPC_NONNULL1
void
xpc_lite_array_set_uuid(xpc_lite_object_t xarray, size_t index, const uuid_t uuid);

/*!
 * @function xpc_lite_array_set_fd
 *
 * @abstract
...
XPC_EXPORT XPC_NONNULL1
void
xpc_lite_array_set_fd(xpc_lite_object_t xarray, size_t index, int fd);

/*!
 * @function xpc_lite_array_set_connection
 *
 * @abstract
 ...
 * corresponding to the primitive value inserted may be safely retrieved with
 * {@link xpc_lite_array_get_value()}. The connection is NOT retained by the array.
 */
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT XPC_NONNULL1
void
xpc_lite_array_set_connection(xpc_lite_object_t xarray, size_t index,
	xpc_lite_connection_t connection);

#pragma mark Array Primitive Getters
/*!
 * @function xpc_lite_array_get_bool
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1
bool
xpc_lite_array_get_bool(xpc_lite_object_t xarray, size_t index);

/*!
 * @function xpc_lite_array_get_int64
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1
int64_t
xpc_lite_array_get_int64(xpc_lite_object_t xarray, size_t index);

/*!
 * @function xpc_lite_array_get_uint64
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1
uint64_t
xpc_lite_array_get_uint64(xpc_lite_object_t xarray, size_t index);

/*!
 * @function xpc_lite_array_get_double
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1
double
xpc_lite_array_get_double(xpc_lite_object_t xarray, size_t index);

/*!
 * @function xpc_lite_array_get_date
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1
int64_t
xpc_lite_array_get_date(xpc_lite_object_t xarray, size_t index);

/*!
 * @function xpc_lite_array_get_data
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1
const void *
xpc_lite_array_get_data(xpc_lite_object_t xarray, size_t index, size_t *length);

/*!
 * @function xpc_lite_array_get_string
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1
const char *
xpc_lite_array_get_string(xpc_lite_object_t xarray, size_t index);

/*!
 * @function xpc_lite_array_get_uuid
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1
const uint8_t *
xpc_lite_array_get_uuid(xpc_lite_object_t xarray, size_t index);

/*!
 * @function xpc_lite_array_dup_fd
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1
int
xpc_lite_array_dup_fd(xpc_lite_object_t xarray, size_t index);

/*!
 * @function xpc_lite_array_create_connection
 *
 * @abstract
 ...
 * responsible for calling xpc_lite_release() on the returned connection. NULL if the
 ...
 * different connection. See {@link xpc_lite_connection_create_from_endpoint()} for
...
xpc_lite_array_create_connection(xpc_lite_object_t xarray, size_t index);

#pragma mark Dictionary
/*!
 * @typedef xpc_lite_dictionary_applier_t
 ...
 */
#ifdef __BLOCKS__
typedef bool (^xpc_lite_dictionary_applier_t)(const char *key, xpc_lite_object_t value);
#endif // __BLOCKS__ 

/*!
 * @function xpc_lite_dictionary_create
 *
 * @abstract
...
/*!
 * @function xpc_lite_dictionary_create_reply
 * 
 * @abstract
...
/*!
 * @function xpc_lite_dictionary_set_value
 *
 * @abstract
...
/*!
 * @function xpc_lite_dictionary_get_value
 *
 * @abstract
...
/*!
 * @function xpc_lite_dictionary_get_count
 *
 * @abstract
 ...
 * not an XPC dictionary. Calling xpc_lite_dictionary_set_value() with a non-NULL
 * value will increment the count. Calling xpc_lite_dictionary_set_value() with a
...
/*!
 * @function xpc_lite_dictionary_apply
 *
 * @abstract
...
/*!
 * @function xpc_lite_dictionary_get_remote_connection
 *
 * @abstract
 ...
 * created through xpc_lite_dictionary_create_reply(), a connection object over which
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL_ALL
xpc_lite_connection_t
xpc_lite_dictionary_get_remote_connection(xpc_lite_object_t xdict);

#pragma mark Dictionary Primitive Setters
/*!
 * @function xpc_lite_dictionary_set_bool
 *
 * @abstract
 ...
 * The <code>bool</code> value to insert. After calling this method, the XPC
 * object corresponding to the primitive value inserted may be safely retrieved
 * with {@link xpc_lite_dictionary_get_value()}.
 */
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT XPC_NONNULL1 XPC_NONNULL2
void
...
/*!
 * @function xpc_lite_dictionary_set_int64
 *
 * @abstract
...
/*!
 * @function xpc_lite_dictionary_set_uint64
 *
 * @abstract
...
/*!
 * @function xpc_lite_dictionary_set_double
 *
 * @abstract
...
/*!
 * @function xpc_lite_dictionary_set_date
 *
 * @abstract
 ...
 * corresponding to the primitive value inserted may be safely retrieved with
 * {@link xpc_lite_dictionary_get_value()}.
 */
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT XPC_NONNULL1 XPC_NONNULL2
void
xpc_lite_dictionary_set_date(xpc_lite_object_t xdict, const char *key, int64_t value);

/*!
 * @function xpc_lite_dictionary_set_data
 *
 * @abstract
...
XPC_EXPORT XPC_NONNULL1 XPC_NONNULL2
void
xpc_lite_dictionary_set_data(xpc_lite_object_t xdict, const char *key, const void *bytes,
	size_t length);

/*!
 * @function xpc_lite_dictionary_set_string
 *
 * @abstract
...
/*!
 * @function xpc_lite_dictionary_set_uuid
 *
 * @abstract
...
XPC_EXPORT XPC_NONNULL1 XPC_NONNULL2
void
xpc_lite_dictionary_set_uuid(xpc_lite_object_t xdict, const char *key, const uuid_t uuid);

/*!
 * @function xpc_lite_dictionary_set_fd
 *
 * @abstract
...
XPC_EXPORT XPC_NONNULL1 XPC_NONNULL2
void
xpc_lite_dictionary_set_fd(xpc_lite_object_t xdict, const char *key, int fd);

/*!
 * @function xpc_lite_dictionary_set_connection
 *
 * @abstract
 ...
 * The connection to insert. After calling this method, the XPC object
 * corresponding to the primitive value inserted may be safely retrieved
 * with {@link xpc_lite_dictionary_get_value()}. The connection is NOT retained by
 * the dictionary.
 */
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT XPC_NONNULL1 XPC_NONNULL2
void
xpc_lite_dictionary_set_connection(xpc_lite_object_t xdict, const char *key,
	xpc_lite_connection_t connection);

#pragma mark Dictionary Primitive Getters
/*!
 * @function xpc_lite_dictionary_get_bool
 *
 * @abstract
...
/*!
 * @function xpc_lite_dictionary_get_int64
 *
 * @abstract
...
/*!
 * @function xpc_lite_dictionary_get_uint64
 *
 * @abstract
...
/*!
 * @function xpc_lite_dictionary_get_double
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL_ALL
double
xpc_lite_dictionary_get_double(xpc_lite_object_t xdict, const char *key);

/*!
 * @function xpc_lite_dictionary_get_date
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL_ALL
int64_t
xpc_lite_dictionary_get_date(xpc_lite_object_t xdict, const char *key);

/*!
 * @function xpc_lite_dictionary_get_data
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1
const void *
xpc_lite_dictionary_get_data(xpc_lite_object_t xdict, const char *key, size_t *length);

/*!
 * @function xpc_lite_dictionary_get_string
 *
 * @abstract
...
/*!
 * @function xpc_lite_dictionary_get_uuid
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1 XPC_NONNULL2
const uint8_t *
xpc_lite_dictionary_get_uuid(xpc_lite_object_t xdict, const char *key);

/*!
 * @function xpc_lite_dictionary_dup_fd
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL_ALL
int
xpc_lite_dictionary_dup_fd(xpc_lite_object_t xdict, const char *key);

/*!
 * @function xpc_lite_dictionary_create_connection
 *
 * @abstract
 ...
 * {@link xpc_lite_connection_create_from_endpoint()} for discussion as to the
 * responsibilities when dealing with the returned connection.
 */
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT XPC_MALLOC XPC_RETURNS_RETAINED XPC_WARN_RESULT XPC_NONNULL_ALL
xpc_lite_connection_t
xpc_lite_dictionary_create_connection(xpc_lite_object_t xdict, const char *key);

#pragma mark Runtime
/*!
 * @function xpc_lite_main
...
typedef void (*xpc_lite_service_event_handler_t)(xpc_lite_connection_t, xpc_lite_object_t);

__OSX_AVAILABLE_BUT_DEPRECATED(__MAC_10_7, __MAC_10_7, __IPHONE_5_0, __IPHONE_5_0)
XPC_EXPORT XPC_NORETURN XPC_NONNULL3
void
xpc_lite_service_main(int argc, const char *argv[],
	xpc_lite_service_event_handler_t handler);
#endif // XPC_HOSTING_OLD_MAIN

#pragma mark Transactions
/*!
 * @function xpc_lite_transaction_begin
 ...
 * message is sent or released. An XPC service may use xpc_lite_transaction_begin()
 * and xpc_lite_transaction_end() to inform the XPC runtime about activity that
...
/*!
 * @function xpc_lite_transaction_end
 * Informs the XPC runtime that a transaction has ended.
 * 
 * @discussion
 * As described in {@link xpc_lite_transaction_begin()}, this API may be used
 * interchangeably with vproc_transaction_end().
 *
 * See the discussion for {@link xpc_lite_transaction_begin()} for details regarding
...
/*!
 * @function xpc_lite_set_event_stream_handler
...
XPC_EXPORT XPC_NONNULL1 XPC_NONNULL3
void
xpc_lite_set_event_stream_handler(const char *stream, dispatch_queue_t targetq,
