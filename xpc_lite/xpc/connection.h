...
#define XPC_ERROR_CONNECTION_INTERRUPTED \
	XPC_GLOBAL_OBJECT(_xpc_lite_error_connection_interrupted)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
const struct _xpc_lite_dictionary_s _xpc_lite_error_connection_interrupted;

/*!
 * @constant XPC_ERROR_CONNECTION_INVALID
 * Will be delivered to the connection's event handler if the named service
 * provided to xpc_lite_connection_create() could not be found in the XPC service
 ...
 * listener or the xpc_lite_main() event handler.
 */


#define XPC_ERROR_TERMINATION_IMMINENT \
	XPC_GLOBAL_OBJECT(_xpc_lite_error_termination_imminent)
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT
const struct _xpc_lite_dictionary_s _xpc_lite_error_termination_imminent;

/*!
 * @constant XPC_CONNECTION_MACH_SERVICE_LISTENER
 * Passed to xpc_lite_connection_create_mach_service(). This flag indicates that the
 ...
 * {@link xpc_lite_connection_set_context} or NULL if no context has been set. It is
 * not safe to reference the connection from within this function.
 *
 * @param value
 * The context object that is to be disposed of.
 */
typedef void (*xpc_lite_finalizer_t)(void *value);

/*!
 * @function xpc_lite_connection_create
 ...
 * xpc_lite_connection_set_target_queue().
 *
 * @result
 * A new connection object. The caller is responsible for disposing of the
 * returned object with {@link xpc_lite_release} when it is no longer needed.
 *
 * @discussion
 ...
 * the first call to xpc_lite_connection_resume().
 *
 * XPC connections, like dispatch sources, are returned in a suspended state, so 
 * you must call {@link xpc_lite_connection_resume()} in order to begin receiving
...
/*!
 * @function xpc_lite_connection_create_mach_service
 ...
 * {@link xpc_lite_connection_set_event_handler()} for the semantics of listener
 * connections versus peer connections.
 * 
 * This method will succeed even if the named service does not exist. This is
 * because the Mach namespace is not queried for the service name until the
 * first call to {@link xpc_lite_connection_resume()}.
 */
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
 ...
 * connection after calling xpc_lite_connection_create() apply to the connection
...
/*!
 * @function xpc_lite_connection_set_target_queue
...
void
xpc_lite_connection_set_target_queue(xpc_lite_connection_t connection,
	dispatch_queue_t targetq);

/*!
 * @function xpc_lite_connection_set_event_handler
 ...
 * xpc_lite_connection_set_event_handler() from within the event handler block.
 *
 ...
 * call xpc_lite_connection_send_message_with_reply_sync() on the connection from
 ...
 * xpc_lite_retain() on the object to obtain a reference to it.
 *
 ...
 * xpc_lite_connection_create() with a non-NULL name argument and a NULL targetq
 ...
 * to accept the connection, you may simply call xpc_lite_connection_cancel() on it
 ...
 * event's lifetime to persist, you must retain it with xpc_lite_retain().
 *
...
void
xpc_lite_connection_set_event_handler(xpc_lite_connection_t connection,
	xpc_lite_handler_t handler);

/*!
 * @function xpc_lite_connection_suspend
 ...
 * queue. All calls to xpc_lite_connection_suspend() must be balanced with calls to
 * xpc_lite_connection_resume() before releasing the last reference to the
 * connection.
 * 
 * @param connection
 * The connection object which is to be manipulated.
 ...
 *
 * Connection event handlers are non-reentrant, so it is safe to call
 * xpc_lite_connection_suspend() from within the event handler block.
 */
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT XPC_NONNULL_ALL
void
xpc_lite_connection_suspend(xpc_lite_connection_t connection);

/*!
 * @function xpc_lite_connection_resume
 * Resumes the connection. Connections start in a suspended state, so you must
 * call xpc_lite_connection_resume() on a connection before it will send or receive
 * any messages.
 * 
 * @param connection
 * The connection object which is to be manipulated.
 ...
 * xpc_lite_connection_suspend() must be balanced with a call to
 * xpc_lite_connection_resume() after the initial call to xpc_lite_connection_resume().
 * After the initial resume of the connection, calling xpc_lite_connection_resume()
 * more times than xpc_lite_connection_suspend() has been called is considered an
 * error.
 */
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT XPC_NONNULL_ALL
void
xpc_lite_connection_resume(xpc_lite_connection_t connection);

/*!
 * @function xpc_lite_connection_send_message
...
XPC_EXPORT XPC_NONNULL_ALL
void
xpc_lite_connection_send_message(xpc_lite_connection_t connection, xpc_lite_object_t message);

/*!
 * @function xpc_lite_connection_send_barrier
 ...
 * xpc_lite_connection_send_message() five times and then call
 * xpc_lite_connection_send_barrier(), the barrier will be invoked after the fifth
 ...
 * xpc_lite_connection_send_barrier(3) is not equivalent to dispatch_async(3).
 */
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT XPC_NONNULL_ALL
void
xpc_lite_connection_send_barrier(xpc_lite_connection_t connection,
	dispatch_block_t barrier);

/*!
 * @function xpc_lite_connection_send_message_with_reply
...
void
xpc_lite_connection_send_message_with_reply(xpc_lite_connection_t connection,
	xpc_lite_object_t message, dispatch_queue_t replyq, xpc_lite_handler_t handler);

/*!
 * @function xpc_lite_connection_send_message_with_reply_sync
 ...
 * conceptually equivalent to calling xpc_lite_connection_send_message_with_reply()
...
xpc_lite_object_t
xpc_lite_connection_send_message_with_reply_sync(xpc_lite_connection_t connection,
	xpc_lite_object_t message);

/*!
 * @function xpc_lite_connection_cancel
...
/*!
 * @function xpc_lite_connection_get_name
...
/*!
 * @function xpc_lite_connection_get_euid
...
XPC_EXPORT XPC_NONNULL_ALL XPC_WARN_RESULT
uid_t
xpc_lite_connection_get_euid(xpc_lite_connection_t connection);

/*!
 * @function xpc_lite_connection_get_egid
...
XPC_EXPORT XPC_NONNULL_ALL XPC_WARN_RESULT
gid_t
xpc_lite_connection_get_egid(xpc_lite_connection_t connection);

/*!
 * @function xpc_lite_connection_get_pid
...
XPC_EXPORT XPC_NONNULL_ALL XPC_WARN_RESULT
pid_t
xpc_lite_connection_get_pid(xpc_lite_connection_t connection);

/*!
 * @function xpc_lite_connection_get_asid
...
XPC_EXPORT XPC_NONNULL_ALL XPC_WARN_RESULT
au_asid_t
xpc_lite_connection_get_asid(xpc_lite_connection_t connection);

/*!
 * @function xpc_lite_connection_set_context
...
XPC_EXPORT XPC_NONNULL1
void
xpc_lite_connection_set_context(xpc_lite_connection_t connection, void *context);

/*!
 * @function xpc_lite_connection_get_context
...
XPC_EXPORT XPC_NONNULL_ALL XPC_WARN_RESULT
void *
xpc_lite_connection_get_context(xpc_lite_connection_t connection);

/*!
 * @function xpc_lite_connection_set_finalizer_f
 ...
 * set by {@link xpc_lite_connection_set_context}.
 *
 ...
 *
 * xpc_lite_connection_set_finalizer_f(object, free);
 */
__OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0)
XPC_EXPORT XPC_NONNULL1
void
