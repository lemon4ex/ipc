 ...
 */
#define XPC_TYPE_ACTIVITY (&_xpc_lite_type_activity)
__OSX_AVAILABLE_STARTING(__MAC_10_9, __IPHONE_7_0)
XPC_EXPORT
XPC_TYPE(_xpc_lite_type_activity);

/*!
 * @typedef xpc_lite_activity_t
 *
 * @abstract
 ...
 */
XPC_DECL(xpc_lite_activity);

/*!
 * @typedef xpc_lite_activity_handler_t
 *
 * @abstract
 * A block that is called when an XPC activity becomes eligible to run.
 */
typedef void (^xpc_lite_activity_handler_t)(xpc_lite_activity_t activity);

/*!
 * @constant XPC_ACTIVITY_CHECK_IN
 * This constant may be passed to xpc_lite_activity_register() as the criteria
...
__OSX_AVAILABLE_STARTING(__MAC_10_9, __IPHONE_7_0)
XPC_EXPORT
const xpc_lite_object_t XPC_ACTIVITY_CHECK_IN;

/*!
 * @function xpc_lite_activity_register
 *
 * @abstract
...
void
xpc_lite_activity_register(const char *identifier, xpc_lite_object_t criteria,
	xpc_lite_activity_handler_t handler);

/*!
 * @function xpc_lite_activity_copy_criteria
 *
 * @abstract
...
xpc_lite_object_t
xpc_lite_activity_copy_criteria(xpc_lite_activity_t activity);

/*!
 * @function xpc_lite_activity_set_criteria
 *
 * @abstract
...
void
xpc_lite_activity_set_criteria(xpc_lite_activity_t activity, xpc_lite_object_t criteria);

/*!
 * @enum xpc_lite_activity_state_t
 * An activity is defined to be in one of the following states. Applications
 * may check the current state of the activity using xpc_lite_activity_get_state()
 * in the handler block provided to xpc_lite_activity_register().
 *
 * The application can modify the state of the activity by calling
 * xpc_lite_activity_set_state() with one of the following:
 ...
 * xpc_lite_activity_register. The state gives the application an opportunity to
 ...
 * XPC_ACTIVITY_STATE_CHECK_IN to xpc_lite_activity_register().
 *
 ...
 * An application may pass this value to xpc_lite_activity_set_state() to indicate
 ...
 *
 * IMPORTANT:
 * This should be done in response to observing xpc_lite_activity_should_defer().
...
typedef long xpc_lite_activity_state_t;

/*!
 * @function xpc_lite_activity_get_state
 *
 * @abstract
...
xpc_lite_activity_state_t
xpc_lite_activity_get_state(xpc_lite_activity_t activity);

/*!
 * @function xpc_lite_activity_set_state
 *
 * @abstract
...
XPC_EXPORT XPC_WARN_RESULT XPC_NONNULL1
bool
xpc_lite_activity_set_state(xpc_lite_activity_t activity, xpc_lite_activity_state_t state);

/*!
 * @function xpc_lite_activity_should_defer
 *
 * @abstract
 ...
 * deferral by calling xpc_lite_activity_set_state() with XPC_ACTIVITY_STATE_DEFER.
...
XPC_EXPORT
bool
xpc_lite_activity_should_defer(xpc_lite_activity_t activity);

/*!
 * @function xpc_lite_activity_unregister
 *
 * @abstract
 ...
 *
 * Unregistering an activity has no effect on any outstanding xpc_lite_activity_t
 * objects or any currently executing xpc_lite_activity_handler_t blocks; however,
...
void
xpc_lite_activity_unregister(const char *identifier);
